...
export default function Nav() {
    ...
    return (
        <>
            <nav className="top-0 left-0 z-20 w-full border-gray-200 py-2.5 px-6 sm:px-4 mb-1">
                <div className="container mx-auto flex max-w-6xl flex-wrap items-center justify-between">
                    ...
                    <div
                        className="items-center justify-between md:order-1 md:flex md:w-auto"
                        id="navbar-sticky"
                    >
                        <ul className="mt-4 flex rounded-lg border-gray-100 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:text-sm md:font-medium">
                            {navigation.map((item) => (
                                <li key={item.href}>
                                    <a
                                        href={item.href}
