...
export default function Error({ error, reset }) {
  const [errorHandleText, setText] = useState("Try again");
  useEffect(() => {
    // Log the error to an error reporting service
    console.log(typeof error, error.digest);
    if (error.digest == "2210890922") {
      setText("Login in");
    }
  }, [error]);
  ...
  return (
    <div
      ...
      className="p-4 mb-4 text-red-800 border bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
      role="alert"
    >
